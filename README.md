Thermostat application with a dynamic visual interface (using jQuery) and utilising Javascript to display the page. Jasmine is used to test-drive the Javascript code. 
